...
class Game(Board):
    ...
    def redraw_window(self, time):
        lm = 70
        self.window.fill((189, 189, 189, 1))
        ...
        menu = fnt.render("M = Back to Menu", 1, (0, 0, 0, 1))
        complete = fnt.render("Press C to complete the board", 1, (0, 0, 0, 1))
        self.window.blit(time, (15, 650))
        self.window.blit(menu, (self.w // 2, 650))
        self.window.blit(complete, (75, 20))
    ...
    def render_menu(self):
        ...
        self.window.blit(Info, (20, self.h / 1.1))
                ...
                if e.key == pygame.K_RETURN:
                    ...
                    if self.start_state == True:
                        ...
                        # Sudoku 1
                            ...
                            self.board = Board(9, 9, 540, 540, m1)
                        ...
                        # Sudoku 2
                            ...
                            self.board = Board(9, 9, 540, 540, m2)
                            self.empty = self.board.is_empty_game()
                            self.start_state = False
                            self.playing = True
                            # Random Sudoku
                        elif self.cursor_state == 'r' and self.transition == False:
                            self.board = Board(9, 9, 540, 540, generate_random_sudoku())
                            self.empty = self.board.is_empty_game()
                            self.start_state = False
                            self.playing = True
                        self.transition = False
